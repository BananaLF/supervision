...
You can use the `addOrg3.sh` script to add another organization to the MHchain test network. The `addOrg3.sh` script generates the Org3 crypto material, creates an Org3 organization definition, and adds Org3 to a channel on the test network.
