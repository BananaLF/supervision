...
function createCommiter() {
  ...
  echo
  set -x
  mh-ca-client register --caname ca-org1 --id.name commiter1 --id.secret commiter1pw --id.type peer --tls.certfiles ${CA_ROOT_PATH}/organizations/mh-ca/org1/tls-cert.pem
  set +x
  ...
  echo
  set -x
  mh-ca-client enroll -u https://commiter1:commiter1pw@localhost:7054 --caname ca-org1 -M ${CA_ROOT_PATH}/organizations/commiterOrganizations/org1.example.com/commiters/commiter1.org1.example.com/msp --csr.hosts commiter1.org1.example.com --tls.certfiles ${CA_ROOT_PATH}/organizations/mh-ca/org1/tls-cert.pem
  set +x
